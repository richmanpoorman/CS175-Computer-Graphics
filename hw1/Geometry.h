...
private:
	void initialize(float x, float y, float z, glm::vec3 normal);
...
public:
	...
	int setVerticies(VertexID newVertexIndicies[3]);
...
private:
	...
	std::unordered_map<VertexID, unordered_set<FaceID>> vertexInFace;
